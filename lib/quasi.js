...
exports.ps = function (opt) {
    ...
    ,   strokeWidth = opt.strokeWidth || "0.015"
    ;
    ...
    ,   plot = function (x_d, y_d, plotflag_i)  {
            ...
            if (dx_d < 1.3 && dy_d < 1 && dx_d > 0 && dy_d > 0) {
                ...
                if (plotflag_i < 1) {
                    ret.push(cmx_d.toFixed(2) + " " + cmy_d.toFixed(2) + " m");
                }
                else {
                    if (oldflag_b) ret.push(cmx_d.toFixed(2) + " " + cmy_d.toFixed(2) + " m");
                    ret.push(cmx_d.toFixed(2) + " " + cmy_d.toFixed(2) + " l");
                    if (plotflag_i === 2)  {
                        ret.push("cp");
                        if (fillon_b)  {
                            ret.push("g");
                        ...
                        if (midon_i[0]) ret.push(gray_d + " sg");
                        ret.push("a");
                    }
                }
                oldflag_b = false;
