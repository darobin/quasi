...
exports.svg = function (opt) {
    ...
    // SVG header
    var ret = [
            '<svg xmlns="http://www.w3.org/2000/svg" width="766" height="567" viewBox="0 0 766 567">'
        ,   '  <g transform="matrix(0 28.3465 -28.3465 0 609.449 28.6299)" stroke-width="' + strokeWidth + '" stroke="none" fill="none">'
        ]
    ,   curObj = {
            commands: []
        }
